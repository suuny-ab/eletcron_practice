...
def configure_container(container: Container = None) -> Container:
    ...
    container.register(LLMTaskService, LLMTaskService, Lifetime.SINGLETON)
    
    # 知识库领域 - 单例
    container.register(KnowledgeRepository, KnowledgeRepository, Lifetime.SINGLETON)
    container.register(KnowledgeService, KnowledgeService, Lifetime.SINGLETON)
...
def create_test_container() -> Container:
    ...
    # container.register(ModelProvider, MockModelProvider, Lifetime.SINGLETON)
